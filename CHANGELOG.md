...
- **Navigation cleanup** — cancelled and timed-out local navigation stops browser-side loading before releasing the session queue, preventing abandoned requests from resuming and interrupting a retry
