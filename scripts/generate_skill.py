...
GROUPS: list[tuple[str, list[str]]] = [
    ...
    (
        "Download",
        ["/download/url", "/download/wait", "/download/wait-click", "/download/list"],
    ),
    (
        "Storage",
    ...
    ("Page Hiding", ["/hide/add", "/hide/remove", "/hide/list"]),
    (
        "Route Interception",
        ["/route/add", "/route/remove", "/route/list", "/route/release"],
    ),
    ("Page Emulation", ["/emulation", "/emulation/headers", "/viewport", "/cdp/send"]),
...
ROUTE_TO_CLI: dict[str, str] = {
    ...
    "/console/clear": "cloak console clear",
    "/download/url": "cloak download url URL",
    "/download/wait": "cloak download wait",
    "/download/wait-click": "cloak download wait-click --index N",
    ...
    "/hide/add": "cloak hide add SELECTOR",
    "/hide/remove": "cloak hide remove ID_OR_SELECTOR",
    "/hide/list": "cloak hide list",
    "/route/add": "cloak route add PATTERN",
    "/route/remove": "cloak route remove",
    "/route/list": "cloak route list",
    "/route/release": "cloak route release",
    "/ws/list": "cloak ws list",
    "/ws/messages": "cloak ws messages",
    "/sse/messages": "cloak sse messages",
    "/debugger/enable": "cloak debugger enable",
    "/debugger/disable": "cloak debugger disable",
    "/debugger/breakpoint/set": "cloak debugger breakpoint-set URL LINE",
    "/debugger/breakpoint/remove": "cloak debugger breakpoint-remove ID",
    "/debugger/breakpoint/list": "cloak debugger breakpoint-list",
    "/debugger/xhr-breakpoint/set": "cloak debugger xhr-set PATTERN",
    "/debugger/xhr-breakpoint/remove": "cloak debugger xhr-remove PATTERN",
    "/debugger/resume": "cloak debugger resume",
    "/debugger/step": "cloak debugger step",
    "/debugger/paused-info": "cloak debugger paused-info",
    "/debugger/scope-variables": "cloak debugger scope-variables OBJECT_ID",
    "/debugger/evaluate": "cloak debugger evaluate CALL_FRAME_ID EXPRESSION",
    "/debugger/scripts": "cloak debugger scripts",
    "/debugger/script-source": "cloak debugger script-source SCRIPT_ID",
    "/debugger/search": "cloak debugger search SCRIPT_ID QUERY",
    "/debugger/skip-pauses": "cloak debugger skip-pauses",
    "/sourcemap/list": "cloak sourcemap list",
    "/sourcemap/get": "cloak sourcemap get SCRIPT_ID",
    "/sourcemap/lookup": "cloak sourcemap lookup SCRIPT_ID --line N --column N",
    "/sourcemap/sources": "cloak sourcemap sources SCRIPT_ID",
    "/sourcemap/source-content": "cloak sourcemap source-content SCRIPT_ID SOURCE_PATH",
    "/profiler/coverage/start": "cloak profiler coverage-start",
    "/profiler/coverage/stop": "cloak profiler coverage-stop",
    "/profiler/coverage/get": "cloak profiler coverage-get",
    "/profiler/cpu/start": "cloak profiler cpu-start",
    "/profiler/cpu/stop": "cloak profiler cpu-stop",
    "/profiler/heap/snapshot": "cloak profiler heap-snapshot --output PATH",
    "/performance/metrics": "cloak performance metrics",
    "/emulation": "cloak emulate",
    "/emulation/headers": "cloak emulation headers",
    "/viewport": "cloak viewport set",
    "/cdp/send": "cloak cdp send",
...
ROUTE_TO_MCP: dict[str, str] = {
    ...
    "/download/wait-click": "agentcloak_download (action=wait-click)",
    ...
    "/hide/add": "agentcloak_hide (action=add)",
    "/hide/remove": "agentcloak_hide (action=remove)",
    "/hide/list": "agentcloak_hide (action=list)",
    "/route/add": "agentcloak_route (action=add)",
    "/route/remove": "agentcloak_route (action=remove)",
    "/route/list": "agentcloak_route (action=list)",
    "/route/release": "agentcloak_route (action=release)",
    ...
    "/debugger/enable": "agentcloak_debugger (action=enable)",
    "/debugger/disable": "agentcloak_debugger (action=disable)",
    "/debugger/breakpoint/set": "agentcloak_debugger (action=breakpoint_set)",
    "/debugger/breakpoint/remove": "agentcloak_debugger (action=breakpoint_remove)",
    "/debugger/breakpoint/list": "agentcloak_debugger (action=breakpoint_list)",
    "/debugger/xhr-breakpoint/set": "agentcloak_debugger (action=xhr_set)",
    "/debugger/xhr-breakpoint/remove": "agentcloak_debugger (action=xhr_remove)",
    "/debugger/resume": "agentcloak_debugger (action=resume)",
    "/debugger/step": "agentcloak_debugger (action=step)",
    "/debugger/paused-info": "agentcloak_debugger (action=paused_info)",
    "/debugger/scope-variables": "agentcloak_debugger (action=scope_variables)",
    "/debugger/evaluate": "agentcloak_debugger (action=evaluate)",
    "/debugger/scripts": "agentcloak_debugger (action=scripts)",
    "/debugger/script-source": "agentcloak_debugger (action=script_source)",
    "/debugger/search": "agentcloak_debugger (action=search)",
    "/debugger/skip-pauses": "agentcloak_debugger (action=skip_pauses)",
    "/sourcemap/list": "agentcloak_sourcemap (action=list)",
    "/sourcemap/get": "agentcloak_sourcemap (action=get)",
    "/sourcemap/lookup": "agentcloak_sourcemap (action=lookup)",
    "/sourcemap/sources": "agentcloak_sourcemap (action=sources)",
    "/sourcemap/source-content": "agentcloak_sourcemap (action=source_content)",
    "/profiler/coverage/start": "agentcloak_profiler (action=coverage_start)",
    "/profiler/coverage/stop": "agentcloak_profiler (action=coverage_stop)",
    "/profiler/coverage/get": "agentcloak_profiler (action=coverage_get)",
    "/profiler/cpu/start": "agentcloak_profiler (action=cpu_start)",
    "/profiler/cpu/stop": "agentcloak_profiler (action=cpu_stop)",
    "/profiler/heap/snapshot": "agentcloak_profiler (action=heap_snapshot)",
    "/performance/metrics": "agentcloak_performance",
    "/emulation": "agentcloak_emulate",
    "/emulation/headers": "agentcloak_headers",
    "/viewport": "agentcloak_viewport",
    "/cdp/send": "agentcloak_cdp_send",
